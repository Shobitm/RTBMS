<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.master" AutoEventWireup="true" CodeFile="ViewHospital.aspx.cs" Inherits="Admin_ViewHospital" %>
        ...
        <div class="col-md-12">
            ...
            <section class="panel">
                <header class="panel-heading">
                    ...
                    <a class="btn btn-primary" href="AddHospital.aspx">Add New</a>
                </header>
                    ...
                    <table class="table table-bordered table-striped mb-none" id="datatable-default">
                        ...
                        <tbody>
                            <%
                                ...
                                List<Tb_Hospital> lst = db.Tb_Hospital.ToList();
                            ...
                            <tr>
                                ...
                                <td class="center hidden-phone">
                                    <a href="/Admin/AddHospital.aspx?catid=<%=item.Id %>">
